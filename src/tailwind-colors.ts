...
/**
 * Tailwind CSS v3 default color palettes.
 *
 * Each palette is the full 11-shade scale in ascending order:
 * [50, 100, 200, 300, 400, 500, 600, 700, 800, 900, 950].
 *
 * Consumed by `theme.ts`, which converts these into Mantine's 10-shade tuples.
 */
